...
#
# def main():
#     reverse_lookup(dict1, "Aray")
#     reverse_lookup(dict1, "a")
#     reverse_lookup(dict1, "Ayau")
#
#
...
#         result = two_dice_roll_sum()
#         result_dict[result] += 1
#
#     print("Total".rjust(10), "|", "Simulated %".rjust(10), "|", "Expected %".rjust(10))
#     print("---------------------------------------------")
#     for n in range(2, 13):
...
#         print(str(n).rjust(10), "|", sim_result.rjust(10), "|", exp_result.rjust(10))
#
#
# if __name__ == '__main__':
#     main()
